...
export default defineConfig({
	...
	shortcuts: {
		'section-base': 'p-8 min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center',
		'btn-primary': 'px-4 py-2 bg-financial-green text-white rounded hover:bg-green-700 transition-colors',
		'btn-secondary': 'px-4 py-2 bg-financial-blue text-white rounded hover:bg-blue-700 transition-colors',
