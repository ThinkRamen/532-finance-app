			...
			<div class='flex flex-col'>
				<div class='flex flex-col items-center justify-center'>
					<SectionCard>
						...
						<h2 class='mb-4'>
							<span class='text-xl'>💵</span> LIQUID ASSETS
						</h2>
						<div class='mb-4'>
						...
						<div class='flex flex-col'>
							...
							<div class='flex'>
								...
								/>
								<button
									class='pixel-btn bg-green-600 hover:bg-green-700 text-white rounded-lg px-6 ml-2 w-full'
				...
				<div class='flex flex-1 flex-col items-center justify-center space-y-4'>
						...
						{formData.assets.length > 0 && (
							<div class='pixel-border p-4 bg-gray-800 rounded mt-4'>
								...
								<div class='text-xs text-gray-400 font-pixel mt-2 text-center'>
									{formData.assets.length} asset{formData.assets.length !== 1 ? 's' : ''} • Avg.
									Return:{' '}
									{(
					...
					<div class='flex justify-center w-full'>
						<button
							...
							onClick={() =>
								document.getElementById('liabilities')?.scrollIntoView({ behavior: 'smooth' })
							}
						>
							Next: Liabilities
						</button>
