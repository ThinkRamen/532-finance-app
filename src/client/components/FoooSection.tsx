				...
				<div class='flex flex-col items-center justify-center space-y-4'>
					<SectionCard class='overflow-y-scroll max-h-xl'>
						...
						<div class='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
							<div class='bg-financial-green/10 border border-financial-green/30 rounded-lg p-4'>
								<div class='flex items-start'>
									<div class='w-10 h-10 bg-financial-green rounded border-2 border-white flex items-center justify-center text-black font-pixel mr-4 flex-shrink-0 shadow-md'>
										1
									</div>
									<div>
										<strong class='text-financial-green font-pixel'>SAFETY NET</strong>
										<p class='text-gray-300 text-sm mt-1'>
											One month of essential expenses to avoid missed payments and overdraft fees.
										</p>
									</div>
								</div>
							</div>
							...
							<div class='bg-financial-red/10 border border-financial-red/30 rounded-lg p-4'>
								<div class='flex items-start'>
									<div class='w-10 h-10 bg-financial-red rounded border-2 border-white flex items-center justify-center text-white font-pixel mr-4 flex-shrink-0 shadow-md'>
										2
									</div>
									<div>
										<strong class='text-financial-red font-pixel'>HIGH INTEREST DEBT</strong>
										<p class='text-gray-300 text-sm mt-1'>
											Pay down debts with APR &gt; 7% before investing for guaranteed returns.
										</p>
									</div>
								</div>
							</div>
							...
							<div class='bg-financial-blue/10 border border-financial-blue/30 rounded-lg p-4'>
								<div class='flex items-start'>
									<div class='w-10 h-10 bg-financial-blue rounded border-2 border-white flex items-center justify-center text-white font-pixel mr-4 flex-shrink-0 shadow-md'>
										3
									</div>
									<div>
										<strong class='text-financial-blue font-pixel'>EMERGENCY FUND</strong>
										<p class='text-gray-300 text-sm mt-1'>
											Build 3-6 months of essential expenses for job loss or major emergencies.
										</p>
									</div>
								</div>
							</div>
							...
							<div class='bg-financial-green/10 border border-financial-green/30 rounded-lg p-4'>
								<div class='flex items-start'>
									...
									<div>
										...
										<p class='text-gray-300 text-sm mt-1'>
											Retirement and brokerage accounts for compound growth and wealth building.
										</p>
									</div>
								</div>
							</div>
						...
						<div class='bg-gray-900/30 border border-gray-600 rounded-lg p-6 mb-6'>
							<div class='flex items-start mb-4'>
								<div class='w-8 h-8 bg-yellow-500 rounded border-2 border-white flex items-center justify-center text-black font-pixel mr-3 flex-shrink-0'>
									!
								</div>
								<div>
									<h3 class='text-yellow-400 font-pixel mb-2'>ACCOUNT SETUP INSTRUCTIONS</h3>
									<p class='text-gray-300 text-sm leading-relaxed'>
										Select accounts for "Safety Net" & "Emergency Fund" that maintain stable
										balances. Avoid accounts with frequent deposits/withdrawals from bill payments.
									</p>
								</div>
							</div>
						</div>
						...
						<div class='space-y-4 mb-8'>
							<div class='bg-financial-green/20 border-l-4 border-financial-green rounded p-4'>
								...
								<div class='text-white'>
									IF &lt; ${calculateBudgetBuckets().needsMonthly?.toFixed(2) || '0.00'} → Divert $
									{calculateBudgetBuckets().savingsMonthly?.toFixed(2) || '0.00'}/month
								</div>
								<div class='text-gray-400 text-sm mt-1'>
									Timespan:{' '}
									{(
										(calculateBudgetBuckets().needsMonthly || 0) /
										(calculateBudgetBuckets().savingsMonthly || 1)
									).toFixed(1)}{' '}
									months
								</div>
							</div>
							...
							<div class='bg-financial-red/20 border-l-4 border-financial-red rounded p-4'>
								...
								<div class='text-white'>
									IF APR &gt; 7% → Divert ${calculateBudgetBuckets().savingsMonthly?.toFixed(2)}/month
									to debt payments
								</div>
								<div class='text-gray-400 text-sm mt-1'>
									Paying off high-interest debt like credit cards at 24-26% APR provides guaranteed
									"returns" that even Warren Buffett's legendary 20% average returns can't beat! The
									S&P 500 averages only 10-12% annually, making debt payoff twice as profitable as
									investing.
								</div>
							</div>
							...
							<div class='bg-financial-blue/20 border-l-4 border-financial-blue rounded p-4'>
								...
								<div class='space-y-2'>
									...
									<div class='text-gray-400 text-sm'>
										Timespan:{' '}
										{(
											((calculateBudgetBuckets().needsMonthly || 0) * 3) /
											(calculateBudgetBuckets().savingsMonthly || 1)
										).toFixed(1)}{' '}
										months
									</div>
									...
									<div class='text-gray-400 text-sm'>
										Timespan:{' '}
										{(
											((calculateBudgetBuckets().needsMonthly || 0) * 6) /
											(calculateBudgetBuckets().savingsMonthly || 1)
										).toFixed(1)}{' '}
										months
									</div>
							...
							<div class='bg-financial-green/20 border-l-4 border-financial-green rounded p-4'>
								...
								<div class='text-white'>
									After 3-6 month emergency fund is complete, maximize investment contributions for
									compound growth.
								</div>
							</div>
						</div>
					...
					<div class='flex justify-center w-full'>
						<button
							...
							onClick={() =>
								document.getElementById('projection')?.scrollIntoView({ behavior: 'smooth' })
							}
						>
