...
export const ProjectionSection = () => {
	return (
		<section class='min-h-screen flex flex-col items-center justify-center p-8 bg-gray-900' id='projection'>
			<SectionCard>
				<h1 class='text-3xl font-bold text-green-400 mb-4'>📈 NET WORTH PROJECTION</h1>
				<h2 class='text-gray-300 mb-6'>See How Your Net Worth Can Grow Over Time</h2>
				<div>
					<label for='projectionYears' class='text-gray-300 mb-2'>
						Projection Years:
					</label>
					<input
						type='number'
						...
						min={1}
						max={50}
						class='ml-2 p-1 rounded bg-gray-800 text-white border border-gray-600'
					/>
				</div>
