        ...
        <section class='flex p-8 bg-gray-900' id='welcome'>
            <div class="flex items-center justify-center">
                <SectionCard>
                    ...
                    <h2 class='text-sm text-gray-300 mb-4'>
                    ...
                    <div class='p-4 rounded-lg text-center'>
                        <p class='text-gray-400 mb-8 text-xs'>
                        ...
                        <div class="flex flex-col justify-center items-center">
                            <button
                                class='pixel-btn py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg mb-2 w-full'
                            ...
                            <button
                                class='pixel-btn py-3 bg-gray-800 hover:bg-gray-900 text-white rounded-lg w-full'
                            >
                                Login
                            </button>
                        </div>
