        ...
        <section class='flex p-8 bg-gray-900' id='welcome'>
            <div class="flex flex-1 items-center justify-center">
                <SectionCard>
                    ...
                    <h2 class='font-semibold mb-4 text-gray-300 text-xl'>
                        Start Building Your Financial Future!!!
                    </h2>
                    <h3 class='font-semibold text-gray-400 text-lg mb-4'>
                    ...
                    <div class='p-4 rounded-lg text-center'>
                        ...
                        <div class="flex flex-col justify-center items-center">
                            ...
                            <button
                                class='pixel-btn py-3 bg-gray-800 hover:bg-gray-900 text-white rounded-lg w-full text-2xl'
                            >
                                Login
                            </button>
                        </div>
