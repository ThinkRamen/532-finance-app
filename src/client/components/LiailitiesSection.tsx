		...
		<section class='flex flex-col p-8 bg-gray-900' id='liabilities'>
			<div class='flex flex-1 items-center justify-center p-8'>
				<SectionCard class='pixel-border-red'>
					<h1 class='text-2xl font-bold text-financial-red mb-4'>LIABILITIES DETAILS</h1>
					<div class='flex-1'>
						{/* LIQUID ASSETS */}
						<div class='py-4'>
							<h2 class='text-xl text-financial-red mb-4 font-pixel'>
								<span class='p-4 text-xl'>💳</span>DEBT OBLIGATIONS
							</h2>
							<label for='accountType' class='block text-gray-300 mb-2'>
								Account Type
							</label>
							<div class='flex'>
								<select
						...
						<div class='py-4'>
							<label for='accountName' class='block text-gray-300 mb-2'>
								Account Name
							</label>
							<div class='flex'>
								<input
						...
						<div class='py-4'>
							<label for='accountValue' class='block text-gray-300 mb-2'>
								Value
							</label>
							<div class='flex'>
								<input
								...
								/>
								<button
									class='pixel-btn-red bg-red-600 hover:bg-red-700 text-white rounded-lg px-6 ml-2'
			...
			<div class='flex flex-col flex-1 p-8 items-center justify-center'>
				<SectionCard class='pixel-border-red'>
								...
								{formData.liabilities.map((liability) => (
									<div class='pixel-border-red p-4 bg-gray-700 rounded flex flex-col justify-between min-h-[120px]'>
										...
										<div class='flex-1'>
											<div class='flex justify-between items-start mb-2'>
												<div class='flex-1'>
													...
													<div class='text-xs text-gray-400 uppercase'>{liability.type}</div>
												</div>
										...
										<div class='flex justify-between items-end pt-2 border-t border-gray-600'>
											...
											<div class='text-sm'>${liability.value.toFixed(2).toLocaleString()}</div>
										</div>
									</div>
								))}
							</div>
					...
					{formData.liabilities.length > 0 && (
						<div class='pixel-border-red p-4 bg-gray-800 rounded mt-4'>
							...
							<div class='text-xs text-gray-400 font-pixel mt-2 text-center'>
								{formData.liabilities.length} asset{formData.liabilities.length !== 1 ? 's' : ''} • Avg.
								Return:{' '}
								{(
